    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(../../assets/images/big/auth-bg.jpg) no-repeat center center;">
            <div class="auth-box">
                ...
                <div id="loginform">
                    <div class="logo">
                        <h3>Associação dos Pequenos e Medios <br/>Produtores Rurais de Bonfinópolis de Minas</h3><br/><br/>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <form class="form-horizontal mt-3" id="loginform" action="{{route('auth')}}"  method="POST">
                                @csrf
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg cpf" placeholder="CPF" name="cpf" id="cpf" aria-label="Username" aria-describedby="basic-addon1" required>
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            {{-- <label class="custom-control-label" for="customCheck1">Me lembre</label>
